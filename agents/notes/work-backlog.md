...
2026-06-19 | DOCS       | [OPEN]    | Skeleton-file token thresholds are a derived baseline (research 2026-06-19-context-budget); revisit after ~1 week — if a file sits green with huge headroom or nags at yellow, the threshold is wrong, not the file. | LOCAL.md
