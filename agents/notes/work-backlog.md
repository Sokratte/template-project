...
2026-06-24 | DOCS       | [OPEN]    | ~/projects/README.md exec-1 + VM.local mirror still describe recent_sessions.sh + agents_sync.sh two-call bootstrap; real startup uses projects_list.sh and a different exec-1. Reconcile workspace README with reality. | ~/projects/README.md, VM.local/README.md
