...
## File limits moved to HTML comments <!-- keywords: -->

All 10 skeleton files patched: H1 stripped of `· soft: N · hard: M` suffix; `<!-- soft: N · hard: M -->` written on the line immediately after the H1. Invisible in Obsidian/MkDocs/GitHub, greppable in source. Same pattern as `<!-- keywords: -->` on line 1 of content docs.
