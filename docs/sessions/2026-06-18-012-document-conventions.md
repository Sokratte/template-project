<!-- kw: document templates, line-1 index, head -qn1, abstract convention, keywords as relationship graph, no Related fields, ADR-002, traffic-light, decay sweep removed, recent_sessions project name -->
