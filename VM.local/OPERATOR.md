...
Skeleton-file token thresholds for the traffic-light (see `AGENTS.md` → "File limits" for the protocol).
Derivation and reasoning: `template-project/docs/research/2026-06-19-context-budget-and-file-limits.md`.
For Claude: estimate tokens as `wc -w × 1.3`.

| File | Yellow | Red |
|------|-------:|----:|
| `AGENTS.override.md` | 200 | 400 |
| `agents/rules/project.md` | 500 | 1000 |
| `agents/memory/procedural.md` | 1500 | 3000 |
| `agents/notes/scratchpad.md` | 600 | 1200 |
| `agents/notes/work-backlog.md` | 800 | 1500 |
| `agents/commands/session-start.md` | 500 | 800 |
| `ROADMAP.md` (loaded slice) | 800 | 1500 |

Baseline derived 2026-06-19 — revisit after ~1 week of practice.
A project-specific deviation goes in that project's `AGENTS.override.md`.
